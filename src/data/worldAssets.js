...
export const WORLD_CONCEPT_ASSETS = Object.freeze([
  ...
  },
  {
    ...
    environmentId: "environment.cairnmarket-grave-root-orchard-civic-system",
    regionId: "graven_march",
    ...
    generationTool: "built_in_image_generation",
    generationMode: "reference_guided_revision",
    promptSha256: "c67a7666a6f491e7efee890fa7b9d738a39b7c453aa0d346abd718a1543ce849",
    sha256: "6f73cc5e847b9b67be7ae7eea2407fed48b9192d81b87a786447497cf4d54667",
    type: "environment_interior_keyframe",
    use: ["four_root_route_bays", "funeral_kite_claim_state", "suspended_root_trays", "food_mortuary_separation", "collapse_refuges", "manual_service_hoists"],
    promptSummary: "Maintained subterranean grave-root orchard with four suspended route bays, one locally stopped Funeral Kite claim, separate food and mortuary work, two manual hoists, two collapse refuges, and two exterior egresses.",
  },
  {
    id: "concept_bellwater_mobile_service_corridor_four_corner_transfer",
    environmentId: "environment.bellwater-mobile-service-corridor-four-corner-transfer",
    regionId: "graven_march",
    siteId: "site.cairnmarket",
    ...
    generationTool: "built_in_image_generation",
    generationMode: "reference_guided_revision",
    promptSha256: "567b100d8611e5aaeb9b7c5c17501dc20a4a2622fd5c147b6b4a53517fa5f010",
    sha256: "2f2fa3d2248bf12f673d3929894b7f544792d8ff805cbf99909d189272838871",
    type: "environment_exterior_keyframe",
    use: ["four_corner_acre_transfer", "five_civic_service_lines", "school_rope_outage", "reduced_school_service", "manual_gantry_and_seed_pad", "road_convoy_egress"],
    promptSummary: "Bellwater mobile-service corridor with one exhausted-soil Acre on exactly four corner supports, its right-front support raised by a wheeled manual gantry, five distinct civic service lines with only the school rope disconnected, reduced school capacity, one seed pad, and open road egress.",
  },
  {
