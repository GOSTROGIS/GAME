The creator's portrait alcove.

```jsx
<PortraitStage image="./assets/characters/bell-warden-v2.png" alt="Bell-Warden">
  <PortraitCaption name="Bell-Warden" note="keyframe, not final art" />
</PortraitStage>
```
