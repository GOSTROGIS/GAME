...
Accepted visual direction is indexed by repository-relative paths and content hashes in the machine module. Ten accepted concepts now comprise five regional references, the Cathedral of Six Rehearsed Dawns quest-location reference, the Warden Reed exterior/interior pair, and two supplemental Hollow Abbey route studies. The Cathedral does not replace Hollow Abbey's regional keyframe. The supplemental Hollow Abbey studies clarify the west Processional Steps arrival and player-height Mute Nave circulation without fixing facade massing, dimensions, topology, GIS placement, creature anatomy, runtime behavior, or production geometry. Veil Coast and Mirror-Salt still need independently reviewed standalone keyframes; their data and art laws exist, but no image is claimed as accepted here.
