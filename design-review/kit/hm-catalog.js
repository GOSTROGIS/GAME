...
export const CATALOG = [
  /* ------------------------------------------------------------- foliage */
  {
    ...
    group: 'foliage', budgetClass: 'minor', generator: 'foliage.procedural.v1', manifest: true,
  ...
  },
  {
    ...
    group: 'foliage', budgetClass: 'hero', generator: 'foliage.procedural.v1', manifest: false,
    declared: null,
  ...
  /* --------------------------------------------------------------- props */
  {
    ...
    group: 'prop', budgetClass: 'hero', generator: 'prop.procedural.v1', manifest: true,
  ...
  },
  {
    ...
    group: 'prop', budgetClass: 'standard', generator: 'prop.procedural.v1', manifest: true,
  ...
  },
  {
    ...
    group: 'prop', budgetClass: 'minor', generator: 'prop.procedural.v1', manifest: true,
  ...
  /* ---------------------------------------------------------- structures */
  {
    ...
    group: 'structure', budgetClass: 'standard', generator: 'structure.procedural.v1', manifest: true,
  ...
  },
  {
    ...
    group: 'structure', budgetClass: 'hero', generator: 'structure.procedural.v1', manifest: true,
